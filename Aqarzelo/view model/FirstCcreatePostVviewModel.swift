...
class FirstCcreatePostVviewModel {
    ...
    func checkFormValidity() {
        let isFormValid = title?.isEmpty == false && sell?.isEmpty == false && category?.isEmpty == false && space?.isEmpty == false && roomNum?.isEmpty == false && bathsNum?.isEmpty == false && pricePer?.isEmpty == false && totalPrice?.isEmpty == false
