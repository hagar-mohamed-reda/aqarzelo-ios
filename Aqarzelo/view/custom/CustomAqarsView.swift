...
class CustomAqarsView: UIView {
    ...
    func setupViews()  {
        ...
        locationTitleLabel.anchor(top: aqarImageView.bottomAnchor, leading: leadingAnchor, bottom: nil, trailing: trailingAnchor,padding: .init(top: 8, left: 0, bottom: 0, right: 0))
        
        locationDistanceLabel.anchor(top: locationTitleLabel.bottomAnchor, leading: leadingAnchor, bottom: bottomAnchor, trailing: trailingAnchor,padding: .init(top: 8, left: 8, bottom: 8, right: 8))
