//
//  FirstCreateTitleArPostCell.swift
//  Aqarzelo
//
//  Created by Hossam on 9/16/20.
...
class FirstCreateTitleArPostCell: BaseCollectionCell,UITextFieldDelegate {
    
    var aqar:AqarModel?{
        didSet{
            guard let aqar = aqar else { return  }
            iconImageView.image = #imageLiteral(resourceName: "Group 3930")
            textView.text = aqar.titleAr
            handleTextChanged()
...
extension FirstCreateTitleArPostCell: UITextViewDelegate {
