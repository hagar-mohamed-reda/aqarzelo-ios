...
class FilterVC: UIViewController {
    ...
    //
    //        gradientLayer.colors = [#colorLiteral(red: 0.288967818, green: 0.6501119137, blue: 0.6586907506, alpha: 1).cgColor,#colorLiteral(red: 0.4164550006, green: 0.8329908848, blue: 0.693434298, alpha: 1).withAlphaComponent(0.2).cgColor]
    //
