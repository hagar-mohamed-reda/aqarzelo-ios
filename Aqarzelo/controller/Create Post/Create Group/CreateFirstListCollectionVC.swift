...
class CreateFirstListCollectionVC:   UICollectionViewController, UICollectionViewDelegateFlowLayout  {
 ...
 firstCcreatePostVviewModel.title = aqar.title
    ...
    var handleNextVC:((Bool,String?,Int?, String,Int?,Int?,Int?,Int?,Int?)->Void)?
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.item == 0 {
            ...
            cell.handleTextContents = { [unowned self] (number,openNext) in
                ...
                self.enableSixthCell(openNext, index: 6)
            ...
            cell.handleTextContents = { [unowned self] (price,openNext) in
                ...
                self.enableSeventhCell(openNext, index: 7)
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        height = indexPath.item == 6 ? 150 : indexPath.item == 1 ? 150 : indexPath.item == 7 ? 150 : indexPath.item == 0 ? firstHeight+150 :  120
    ...
    fileprivate func bindableFirstAqar(aqar:AqarModel) {
        firstCcreatePostVviewModel.bindableIsFormValidate.bind {  [unowned self ]  (isValid) in
            ...
            guard  let t = self.firstCcreatePostVviewModel.title,let ca = self.firstCcreatePostVviewModel.category?.toInt(), let ty = self.firstCcreatePostVviewModel.sell
    ...
    fileprivate  func handleHidedViews(index:Int)  {
        ...
        case 1:
            if let cell = collectionView.cellForItem(at: IndexPath(item: index-1, section: 0)) as? FirstCreatePostCell {
        ...
        case 3:
            if let cell = collectionView.cellForItem(at: IndexPath(item: index-1, section: 0)) as? FirstCreateSellOrRentCell {
                cell.hideViewsAgain(views: cell.buttonStack,cell.categoryQuestionLabel)
            }
        case 4:
            if let cell = collectionView.cellForItem(at: IndexPath(item: index-1, section: 0)) as? FirstCreateSpaceCell {
                cell.hideViewsAgain(views: cell.mainView,cell.priceLabel)
            }
        case 5:
            if let cell = collectionView.cellForItem(at: IndexPath(item: index-1, section: 0)) as? FirstCreateRoomsNumberCell {
                cell.hideViewsAgain(views: cell.customAddMinusView,cell.questionLabel)
            }
        case 6:
            if let cell = collectionView.cellForItem(at: IndexPath(item: index-1, section: 0)) as? FirstCreateBathsNumberCell {
                cell.hideViewsAgain(views: cell.customAddMinusView,cell.questionLabel)
            }
        case 7:
            if let cell = collectionView.cellForItem(at: IndexPath(item: index-1, section: 0)) as? FirstCreatePriceCell {
                cell.hideViewsAgain(views: cell.mainView,cell.priceLabel)
            }
        default:
            ()
